		...
		if (B[b].what >= 99) {
			...
			if (B[b].life != 0) {
				...
				if (B[b].what >= 100 && B[b].what < 200) {
					if (B[b].what % 5 == 0)cout << "胎";
					if (B[b].what % 5 == 1)cout << "神";
				...
				if (B[b].what >= 200 && B[b].what < 300) {
					...
					if (B[b].what % 6 == 2)cout << "胎";
					if (B[b].what % 6 == 3)cout << "神";
...
void Ball(int ball) {
	if (ball == 1) {
		int f = 0;
		for (int i = 1; i <= 3; i++) {
			if (fir[i] == 1) fir[i]--, Fir++;
			else if (fir[i] > 1) fir[i]--;
			else f = i;
		}
		if (Fir > 0 && f != 0) {
			br++;
			...
			B[br].y = Y + rand() % 3 - 1;
			B[br].life = 1;
			if (Dis <= 30) B[br].a = Disb, B[Disb].a = 1, fir[f] = 20, Fir--;
			else if (Boss != 0) B[br].a = 13880086, fir[f] = 20, Fir--;
			else if (Dis != 13880087) B[br].a = Disb, B[Disb].a = 1, fir[f] = 20, Fir--;
			else if (Dis1 != 13880087) B[br].a = Disb1, B[Disb1].a = 1, fir[f] = 20, Fir--;
			else B[br].life = 0;
			Dis = Dis1 = 13880087;
		}
	}
