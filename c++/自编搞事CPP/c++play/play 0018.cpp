...
void Cout(int x, int a) {
	...
	if (x == 2) {
		if (a == 1) cout << "步兵", Money += 20, k = 20;
		if (a == 2) cout << "骑兵", Money += 30, k = 30;
		if (a == 3) cout << "炮兵", Money += 30, k = 30;
		if (a == 4) cout << "药兵", Money += 30, k = 30;
		if (a == 6 || a == 7) cout << "炮灰", Money += 10, k = 10;
		if (a == 5) cout << "坦克", Money += 50, k = 50;
		if (a == 8) Yan(3), cout << "金刚机甲", Money += 100;
		if (a == 9) Yan(1), cout << "寒冰机甲", Money += 100;
		if (a == 10) Yan(2), cout << "木毒机甲", Money += 100;
		if (a == 11) Yan(3), cout << "飓风机甲", Money += 100;
		if (a == 12) Yan(4), cout << "烈焰机甲", Money += 100;
		if (a >= 8) k = 100;
	}
	Yan(4);
	Sleep(200), cout << "......爆！！！";
	if (x == 2) Yan(5), cout << "掉落" << k << "金币！";
	cout << endl << endl, Sha++;
...
void War() {
	...
	for (int i = 1; i <= 5; i++) {
		...
		if (D[i].Zhong == 4) cout << "  ▽";
		if (D[i].Zhong == 5) cout << "  ☆";
		if (D[i].Zhong >= 6 && D[i].Zhong <= 7) cout << "  ◇";
		if (D[i].Zhong == 8) Yan(5), cout << "  金";
		if (D[i].Zhong == 9) Yan(1), cout << "  冰";
		if (D[i].Zhong == 10) Yan(2), cout << "  毒";
		if (D[i].Zhong == 11) Yan(3), cout << "  风";
		if (D[i].Zhong == 12) Yan(4), cout << "  火";
		Bai();
	}
	if (zn > 0 || zd > 0) {
		cout << " ┆" << endl << "┆";
...
void Die(int m) {
	if (D[m].Xue <= 0) {
		...
		D[dl].Xue = 0, D[dl].Zhong = 0, D[dl].Bing = 0;
		dl--;
		int a = rand() % 10;
		if (a == 0 && t < 1000) {
			Yan(4);
			...
			int b = rand() % 5;
			if (b == 0) {
				cout << "导弹！" << endl << endl, Dao++;
				Sleep(2000);
				if (Daob == 0) Ju(0);
				Daob = 1;
			}
			if (b == 1) {
				cout << "医疗包！" << endl << endl, Yi++;
				Sleep(2000);
				if (Yib == 0) Ju(1);
				Yib = 1;
			}
			if (b == 2) {
				cout << "闪光弹！" << endl << endl, Shan++;
				Sleep(2000);
				if (Shanb == 0) Ju(2);
				Shanb = 1;
			}
			if (b == 3) {
				cout << "狂暴血清！" << endl << endl, Qing++;
				Sleep(2000);
				if (Qingb == 0) Ju(3);
				Qingb = 1;
			}
			if (b == 4) {
				cout << "无敌护罩！" << endl << endl, Hu++;
				Sleep(2000);
				if (Hubb == 0) Ju(4);
				Hubb = 1;
			}
...
void DieN(int m) {
	if (N[m].Xue <= 0) {
		...
		N[nl].Xue = 0, N[nl].Zhong = 0, N[nl].Bing = 0, N[nl].Hui = 0;
		nl--;
	}
}
void Zao(int a) {
	...
	if (a == 5) {
		N[nl].Xue = N[nl].Zhong = 0, Money -= 250;
		for (int i = nl; i > 0; i--) swap(N[i], N[i - 1]);
		N[1].Xue = 500;
	}
	if (a == 6) N[nl].Xue = 400, N[nl].Zhong = 6, Money -= 270;
	if (a == 7) N[nl].Xue = 300, N[nl].Zhong = 5, Money -= 300;
	Yan(5);
	cout << endl << "建造成功！" << endl << endl;
	Sleep(500);
	cout << "你的金币数量：" << Money;
	Bai();
	Jian++;
...
void Yong(int a) {
	int b;
	if (a == 0) return;
	if ((a == 1 && Dao == 0) || (a == 2 && Yi == 0) || (a == 3 && Shan == 0) || (a == 4 && Qing == 0) || (a == 5 && Hu == 0)) {
		cout << "无效输入。" << endl;
		Sleep(500);
		return;
	}
	if (a == 1) {
		...
		Yan(4), cout << endl << "导弹发射！命中目标！" << endl << endl;
		Bai(), D[b].Xue -= 300;
		Die(b), Bai(), Dao--;
		return;
	}
	if (a == 2) {
		...
		Yan(4), cout << endl << "医疗包开始医疗！" << endl << endl;
		Bai(), N[nl - b + 1].Hui += 5, Bai(), Yi--;
		return;
	}
	if (a == 3) {
		cout << endl << "闪光弹随时准备发射！";
		...
		Yan(4), cout << endl << "闪光弹发射！命中目标！" << endl << endl;
		Bai(), Biao = b, D[b].Bing += 5, Biaob += 5, Shan--;
		return;
	}
...
y:
	while (Money >= 100) {
		...
		if (Money >= 100) cout << "你现在可以购买：1.加农炮  ";
		if (Money >= 120 && X[2] < 5) cout << "2.重机枪  ";
		if (Money >= 150 && X[3] < 5) cout << "3.迫击炮  ";
		if (Money >= 200 && X[4] < 3) cout << "4.喷火器  ";
		if (Money >= 250 && X[0] == 0) cout << "5.城墙  ";
		if (Money >= 270 && X[6] + X[7] + X[8] < 2) cout << "6.电磁炮  ";
		if (Money >= 300 && X[5] < 3) cout << "7.火箭炮";
		if (Money >= 100) {
			cout << endl << endl << "---你想购买什么？（按0取消）---  ";
			a = _getch();
			cout << a << endl;
			if (a == '0') break;
			if (a < '0' || a > '7') {
...
z:
	while (Dao > 0 || Yi > 0 || Shan > 0 || Qing > 0 || Hu > 0) {
		War();
		if (Dao > 0 || Yi > 0 || Shan > 0 || Qing > 0 || Hu > 0) cout << "你现在可以使用：";
		if (Dao > 0) cout << "1.导弹(" << Dao << "个) ";
		if (Yi > 0) cout << "2.医疗包(" << Yi << "个) ";
		if (Shan > 0) cout << "3.闪光弹(" << Shan << "个) ";
		if (Qing > 0) cout << "4.狂暴血清(" << Qing << "个) ";
		if (Hu > 0) cout << "5.无敌护罩(" << Hu << "个) ";
		if (Dao > 0 || Yi > 0 || Shan > 0 || Qing > 0 || Hu > 0) {
			cout << endl << endl << "---你想使用什么？（按0取消）---  ";
			a = _getch();
			cout << a << endl;
			if (a == '0') break;
			if (a < '0' || a > '9') {
...
void Bjing(int n, int i) {
	int x = rand() % 5;
	int y = rand() % 10;
	int R = 190 + rand() % 21, R2 = 30 + rand() % 21;
	if (x == 0 && D[i].Bing == 0) {
		Yan(4), cout << "金刚机甲锤击！" << R << "点伤害！" << endl << endl;
		if (Hub == 0 && D[i].Bing == 0) N[1].Xue -= R, DieN(1);
		return;
	}
	if (x >= 1 && x < 3 && D[i].Bing == 0) {
		Yan(4), cout << "金刚机甲扫射！" << R2 << "*" << nl << "点伤害！" << endl << endl;
		if (Hub == 0 && D[i].Bing == 0) for (int i = 1; i <= nl; i++) N[i].Xue -= R2, DieN(i);
		return;
	}
	if (nl < 4 && dl >= 3) {
		cout << "金刚机甲蓄力。" << endl << endl;
		return;
	}
	if (x == 3) {
		Yan(4), cout << "金刚机甲召唤！" << endl << endl;
		Chu(y);
		Bai();
		War();
	}
...
void Bbing(int n, int i) {
	...
	if (x < 2 && D[i].Bing == 0) {
		...
		Yan(4), cout << "寒冰机甲攻击！冰冻了你方第";
		cout << nl - y + 1;
		Sleep(100);
		cout << "个目标，";
		Sleep(300);
		cout << R << "点伤害！" << endl << endl;
		Bai();
		Sleep(500), War();
		return;
	}
	if ((dl >= 3 && nl < 4) || x == 2) {
		cout << "寒冰机甲蓄力。" << endl << endl;
		return;
	}
	if (x == 3) {
		Yan(4), cout << "寒冰机甲召唤！" << endl << endl;
		Chu(z);
		Bai();
		War();
	}
...
void Bdu(int n, int i) {
	...
	if (x == 2 && D[i].Bing == 0) {
		Yan(4), cout << "木毒机甲向己方放毒！所有敌人中毒，攻速*2！" << endl << endl, Baodb = 2;
		return;
	}
	if ((x > 4) || (nl < 4 && dl >= 3)) {
		cout << "木毒机甲蓄力。" << endl << endl;
		return;
	}
	if (x > 2 && x <= 4) {
		Yan(4), cout << "木毒机甲召唤！" << endl << endl;
		Chu(y);
		Bai();
		War();
	}
...
void Bju(int n, int m, int i) {
	int x = rand() % 5, xx = rand() % 10, y, yy, z, zz;
	int R = 40 + rand() % 21;
	if (nl == 1) while (x == 0) x = rand() % 5;
	else {
		y = rand() % n + 1;
		z = y;
		while (z == y) z = rand() % n + 1;
	}
	if (dl == 1) while (x == 1) x = rand() % 5;
	else {
		yy = rand() % m + 1;
		zz = yy;
		while (zz == yy) zz = rand() % m + 1;
	}
	if (x == 0 && D[i].Bing == 0) {
		Yan(4), cout << "飓风机甲刮起狂风！调换了你方第" << n - y + 1 << "个和" << n - z + 1 << "个炮塔的位置，";
		swap(N[y], N[z]);
		if (Hub == 0) Sleep(300);
		cout << R << "*2点伤害！", N[y].Xue -= R, N[z].Xue -= R, DieN(y), DieN(z);
		cout << endl << endl;
		Bai();
		Sleep(500), War();
		return;
	...
	if (x == 1 && D[i].Bing == 0 && Fengb == 0) {
		Yan(4), cout << "飓风机甲刮起狂风！调换了己方第" << yy << "个和" << zz << "个敌人的位置！" << endl << endl;
		swap(D[yy], D[zz]);
		Bai();
		Sleep(500), War();
		Fengb = 1;
	...
	if ((dl >= 3 && nl < 4) || x == 5) {
		cout << "飓风机甲蓄力。" << endl << endl;
		return;
	}
	if (x == 2) if (Hub == 0 && D[i].Bing == 0) {
			cout << "飓风机甲刮起狂风！前三个炮塔血量减30%！" << endl << endl;
			if (N[3].Xue != 0) N[3].Xue *= 0.7, DieN(3);
			if (N[2].Xue != 0) N[2].Xue *= 0.7, DieN(2);
			if (N[1].Xue != 0) N[1].Xue *= 0.7, DieN(1);
		}
	if (x == 3) {
		Yan(4), cout << "飓风机甲召唤！" << endl << endl;
		Chu(xx);
		Bai();
		War();
	}
...
void Byan(int n, int i) {
	...
	if ((nl < 4 && dl >= 3) || x == 2) {
		cout << "烈焰机甲蓄力。" << endl << endl;
		return;
	}
	if (x == 3) {
		Yan(4), cout << "烈焰机甲召唤！" << endl << endl;
		Chu(y);
		Bai();
		War();
	}
...
void Round() {
	...
	if (Biaob == 0) Biao = 0;
	if (D[1].Xue <= 0) {
		if (t != 0) cout << "炮塔暂时没有发现敌人。" << endl << endl;
		Sleep(500);
		for (int i = nl; i > 0; i--) {
			int b = 0;
			Yan(N[i].Zhong);
			if (N[i].Zhong == 0) {
				cout << "城墙巍然不动。" << endl << endl;
			}
			...
			if (b == 0 && N[i].Zhong == 8 && N[i].Bing == 0) {
				cout << "电磁炮，", Yan(4), Sleep(200), cout << "第3环，点亮！";
				Sleep(200);
				cout << "蓄势待发！" << endl << endl;
				Bai();
			}
		...
		for (int j = 1; j <= Baod; j++) {
			...
			for (int i = 1; i <= dl; i++) {
				...
				if (c == 0 && D[i].Zhong == 7 && nl >= 0 && D[i].Bing == 0) {
					R = 490 + rand() % 21, cout << "炮灰", Yan(4), cout << "爆炸！！！", Sleep(500), cout << R << "点伤害！" << endl << endl;
					if (Hub == 0) N[1].Xue -= 500, DieN(1);
					D[i].Xue -= 500, Die(i), c = 1;
				}
		...
		for (int j = 1; j <= Bao; j++) {
			...
			for (int i = nl; i > 0; i--) {
				...
				if (N[i].Zhong == 1 && D[1].Zhong != 0 && N[i].Bing == 0) {
					if (D[1].Zhong != 0)R = 20 + rand() % 21, cout << "加农炮一炮发出！" << R << "点伤害！" << endl << endl;
					if (Biao != 0) D[Biao].Xue -= R, Die(Biao);
					else D[1].Xue -= R, Die(1);
					Sleep(200);
				}
				if (N[i].Zhong == 2 && D[1].Zhong != 0 && N[i].Bing == 0) {
					if (D[1].Zhong != 0)R = 40 + rand() % 21, cout << "重机枪射出复仇的子弹！" << R << "点伤害！" << endl << endl;
					if (Biao != 0) D[Biao].Xue -= R, Die(Biao);
					else D[1].Xue -= R, Die(1);
					Sleep(200);
				}
				if (N[i].Zhong == 3 && D[1].Zhong != 0 && N[i].Bing == 0) {
					if (D[1].Zhong != 0)R = 60 + rand() % 21, cout << "迫击炮的炮弹划出一条完美的抛物线！" << R << "点伤害！" << endl << endl;
					if (Biao != 0) D[Biao].Xue -= R, Die(Biao);
					else D[dl].Xue -= R, Die(dl);
					Sleep(200);
				}
				if (N[i].Zhong == 4 && D[1].Zhong != 0 && N[i].Bing == 0) {
					if (D[1].Zhong != 0)R = 40 + rand() % 21, R2 = 20 + rand() % 21, R3 = rand() % 21, cout << "喷火器喷出熊熊烈火！" << R << "+" << R2 << "+" << R3 << "点伤害！" << endl << endl;
					if (Biao != 0) {
						if (D[Biao + 2].Zhong != 0)D[Biao + 2].Xue -= R3, Die(Biao + 2);
						if (D[Biao + 1].Zhong != 0)D[Biao + 1].Xue -= R2, Die(Biao + 1);
						if (D[Biao].Zhong != 0)D[Biao].Xue -= R, Die(Biao);
					} else {
						if (D[3].Zhong != 0)D[3].Xue -= R3, Die(3);
						if (D[2].Zhong != 0)D[2].Xue -= R2, Die(2);
						if (D[1].Zhong != 0)D[1].Xue -= R, Die(1);
					}
					Sleep(200);
				}
				if (N[i].Zhong == 5 && D[1].Zhong != 0 && N[i].Bing == 0) {
					if (dl != 0) cout << "火箭炮的7枚火箭依次冲出！命中第";
					Huo(dl);
					Sleep(200);
				}
				...
				if (b == 0 && N[i].Zhong == 8 && N[i].Bing == 0) {
					cout << "电磁炮，", Yan(4), Sleep(200), cout << "第3环，点亮！";
					if (D[1].Zhong != 0) {
						R = 290 + rand() % 21, R2 = 90 + rand() % 21, Sleep(200);
						cout << "然后...", Sleep(200), cout << "轰！！！", Sleep(200), cout << R << "+" << R2 << "点伤害！" << endl << endl, N[i].Zhong -= 2;
						if (Biao != 0) {
							if (D[Biao + 1].Zhong != 0)D[Biao + 1].Xue -= R2, Die(Biao + 1);
							D[Biao].Xue -= R, Die(Biao), b = 1;
						} else {
							if (D[2].Zhong != 0)D[2].Xue -= R2, Die(2);
							D[1].Xue -= R, Die(1), b = 1;
						}
					} else cout << "蓄势待发！" << endl << endl;
					Bai();
					Sleep(200);
				}
				Bai();
		...
		if (nl <= 0) {
			...
			Sleep(2000);
			system("cls");
			cout << endl << "城破了，你输了！！！" << endl << endl;
			Sleep(1000);
			cout << "你坚守了" << t << "天。" << endl << endl;
			Bai();
			Sleep(1000);
			system("pause");
			return;
...
x:
		...
		if (t == 99) {
			system("cls");
			Sleep(500);
			cout << "第100天" << endl << endl;
			Yan(5);
			cout << "飞机的轰鸣声响过，你的视野变为雪白......" << endl << endl;
			Sleep(1000);
			cout << "激烈的战场瞬间寂静，机甲轰然倒塌......" << endl << endl;
			Sleep(1000);
			cout << "在层层迷雾中，远方若隐若现地显出军队的轮廓......" << endl << endl;
			Sleep(1000);
			cout << "啊，你的援军到了！！！" << endl << endl;
			Sleep(1000);
			cout << "伟大的将帅啊，我们的首都，保住了！！！" << endl << endl;
			Sleep(3000);
			system("cls");
			Bai();
			cout << endl << "游戏目标达成，游戏结束！" << endl << endl;
			Sleep(2000);
			system("pause");
			return;
		}
...
void Jiao() {
	...
	cout << "└-------------------------┘" << endl;
	Sleep(2000);
	cout << "请按1键以建造加农炮。" << endl << endl;
	a = _getch();
	N[1].Zhong = 1, N[1].Xue = 100, nl++;
	War();
	cout << "好极了，他应该能帮我们守住城市。" << endl << endl;
	Sleep(1000);
	system("pause");
	system("cls");
	cout << "┌-------------------------┐" << endl;
	...
	system("cls");
	War();
	cout << "现在看看你的加农炮能把它怎么样！" << endl << endl;
	Sleep(1000);
	t = 3305536, Round();
	cout << "加农炮血多价廉，是战斗前期的必备。" << endl << endl;
	Sleep(1000);
	system("pause");
	system("cls");
	cout << "┌-------------------------┐" << endl;
	...
	cout << "└-------------------------┘" << endl;
	Sleep(2000);
	cout << "重机枪攻击力高，可以大量输出火力。" << endl << endl;
	Sleep(1000);
	system("pause");
	system("cls");
	cout << "┌-------------------------┐" << endl;
	...
	cout << "└-------------------------┘" << endl;
	Sleep(2000);
	cout << "迫击炮攻击力高，并可以在一些血少敌人出场时将其击杀。" << endl << endl;
	Sleep(1000);
	system("pause");
	system("cls");
	cout << "┌-------------------------┐" << endl;
	...
	cout << "└-------------------------┘" << endl;
	Sleep(2000);
	cout << "坦克，你的噩梦！" << endl << endl;
	Sleep(2000);
	system("pause");
	system("cls");
	cout << endl << "开局时，你有一个城墙。" << endl << endl;
	Sleep(2000);
	cout << "建造炮塔要花费金币，你的金币每回合+10。" << endl << endl;
	Sleep(2000);
	cout << "后期会出BOSS——机甲，这时你的金币每回合+30。" << endl << endl;
	Sleep(2000);
	cout << "你的金币储量上限为300。" << endl << endl, Sleep(2000);
	cout << "敌人的血量随天数增加！" << endl << endl;
	Sleep(2000);
	cout << "打爆一个敌人有几率掉道具。" << endl << endl;
	Sleep(2000);
	cout << "每个炮塔一回合只能攻击一次。" << endl << endl;
	Sleep(2000);
	cout << "当所有炮塔阵亡时，游戏结束。" << endl << endl;
	Sleep(2000);
	cout << "伟大的将帅啊，请你保卫我们的首都！" << endl << endl;
	Sleep(2000);
	system("pause");
	system("cls");
}
...
st:
	...
	a = _getch();
	if (a == '1') {
		Jiao(), N[1].Zhong = 0, N[1].Xue = 500, nl = 1, Money = 90;
		cout << endl << "现在进行战争模式。" << endl << endl;
		Sleep(1000);
		t = 0;
		Round();
		goto ST;
	} else if (a == '2') {
		N[1].Zhong = 0, N[1].Xue = 500, nl = 1, Money = 90;
		cout << endl << " 现在进行战争模式。" << endl << endl;
		Sleep(1000);
		t = 0;
		Round();
