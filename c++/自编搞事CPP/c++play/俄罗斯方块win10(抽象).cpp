...
using namespace std;
long long iii=21,jjj=5,dd,i,j,i1,i2,j2,i3,j3,fs=0,maxfs=0,j11,d,panding=0,suiji,mapp[100][100],yanshi=10,suiji1,suiji2,UI=1,gameover=0,xz,nx,ny,gg;
...
int main()
{
	...
	while(1)
	{
		...
		if(UI==1)
		{
			system("cls");
			UI=0;
			cout<<"     俄罗斯方块"<<endl<<endl<<"     1 经典模式"<<endl<<endl<<"     2 双人配合"<<endl<<endl<<"     Z 作者简介";
		}
