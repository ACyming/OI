...
int main(){
	int a;
	cout<<"欢迎来到cym系统..."<<endl<<"如有建议，请联系qq:2927705879;网易邮箱：jason29277@163.com;电话：13420365437";
	cout<<"\n想玩火柴人快跑的话输入1，想玩猜数游戏的话输入2,想玩打怪游戏的话输入3，想用计算机的话输入4\n(计算机调试过程中....能计算像1+1这种算式，只支持+ - * /)"<<endl; 
	cin>>a;
	system("cls"); 
	if(a==1)
	{
	...
	cout << "下面作者要问你一个严肃的问题！！你只需要回答是或者不是!!!回答Y(是)或者N(不是)！" << endl;Sleep(3000);
	...
	else
	{
		...
		cout << "作者再给你一次机会。你觉得作者帅不帅，你只需要回答是或者不是？" << endl;Sleep(2900);
